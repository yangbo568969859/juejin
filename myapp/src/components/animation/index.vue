...
<style scoped>
  ...
  .chest {
    animation: chest 10s .05s cubic-bezier(0.645, 0.045, 0.355, 1) both infinite;
    height: 110%;
    width: 130px;
    left: -30px;
    z-index: 1
  ...
  .fur:first-child {
    animation: fur-center 10s .1s cubic-bezier(0.645, 0.045, 0.355, 1) both infinite;
    height: 110px;
    width: 110px;
    left: calc(50% - 55px);
    z-index: 1;
  ...
  .fur:first-child>.patch:after {
    animation: fur-center-patch-right 10s .07s cubic-bezier(0.645, 0.045, 0.355, 1) both infinite;
    left: initial;
    right: 25%;
    top: 0;
    transform: rotate(35deg) skewX(15deg);
  ...
  .fur:nth-child(3) {
    animation: fur-right 10s .15s cubic-bezier(0.645, 0.045, 0.355, 1) both infinite;
    right: -20px
  }
  .fur>.patch:before,
  .fur>.patch:after {
  ...
  .ear:before,
  .ear:after {
    animation: ear 10s .1s cubic-bezier(0.645, 0.045, 0.355, 1) both infinite;
  ...
  .eye {
    ...
    background-image: radial-gradient(ellipse 5px 10px at 50% 65%, #260f02 0, #260f02 99%, rgba(0, 0, 0, 0) 100%), radial-gradient(ellipse 10px 20px at 50% 90%, #955d27 0, #955d27 99%, rgba(0, 0, 0, 0) 100%), radial-gradient(ellipse 4px 6px at 55% 20%, #fff 0, #fff 99%, rgba(0, 0, 0, 0) 100%)
  }
  .eye:last-child {
    right: 10%;
  ...
  .leg:nth-child(2)~*,
  .leg:nth-child(2)~*>.inner-leg,
  .leg:nth-child(2)~*>.inner-leg:before {
    animation-delay: .07s
  }
  .leg:nth-child(3) {
    left: 35px;
